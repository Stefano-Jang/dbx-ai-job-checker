...
> **Job이 성공했다고 결과까지 맞는 것은 아닙니다.** AI Job Checker는 실행 직후 성능 이상, freshness/completeness, 비즈니스 정의와 Notebook 구현의 불일치를 검사하고 수정 가능한 diff까지 만듭니다.
...
| 어디를 고칠지 모름 | 설명과 바로 검토 가능한 unified diff |
